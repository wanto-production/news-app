...
<template>
    <header class=" w-full h-[60px] flex justify-between items-center px-2 fixed top-0 ">
    ...
    <div class="w-full fixed h-[3px] bg-gradient-to-r from-[#4a90e2] to-[#8e44ad] top-[140px] min-[526px]:top-[100px] " />
</template>